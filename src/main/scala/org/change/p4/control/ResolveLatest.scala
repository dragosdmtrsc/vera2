...
import org.change.p4.model.control.exp.FieldRefExpr
import org.change.p4.model.parser.{ExtractStatement, IndexedHeaderRef, State}
    ...
    if (fieldRefExpr.getFieldRef.getHeaderRef == null) {
      if (latest != null) {
        ...
        throw new IllegalStateException(
          s"unknown reference to latest in $fieldRefExpr"
        )
      }
    }
  }
