...
import org.change.v2.p4.model.actions.P4ActionCall.{Param, ParamExpression}
...
class Traverse(visitor: ASTVisitor) {
  ...
  def apply(statement: ControlStatement): Unit = statement match {
    ...
    case applyControlStatement: ApplyControlStatement => apply(applyControlStatement)
  ...
  def apply(applyAndSelectTableStatement: ApplyAndSelectTableStatement) : Unit = {
  ...
  def apply(action : org.change.v2.p4.model.actions.primitives.Add) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.AddHeader) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.AddToField) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.BitAnd) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.BitOr) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.BitXor) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.CloneEgressPktToEgress) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.CloneEgressPktToIngress) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.CloneIngressPktToEgress) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.CloneIngressPktToIngress) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.CopyHeader) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.Count) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.Drop) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.ExecuteMeter) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.GenerateDigest) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.ModifyField) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.ModifyFieldRngUniform) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.ModifyFieldWithHashBasedOffset) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.NoOp) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.Pop) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.Push) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.Recirculate) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.RegisterRead) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.RegisterWrite) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.RemoveHeader) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.Resubmit) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.ShiftLeft) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.ShiftRight) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.Subtract) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.SubtractFromField) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  def apply(action : org.change.v2.p4.model.actions.primitives.Truncate) : Unit = {
    if (visitor.preorder(action)) {
      visitor.postorder(action)
    }
  }
  ...
  def apply(action : org.change.v2.p4.model.actions.P4ComplexAction) : Unit = {
    if (visitor.preorder(action)) {
  ...
  def apply(action : org.change.v2.p4.model.actions.P4Action): Unit = action match {
    case ax : org.change.v2.p4.model.actions.primitives.Add => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.AddHeader => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.AddToField => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.BitAnd => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.BitOr => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.BitXor => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.CloneEgressPktToEgress => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.CloneEgressPktToIngress => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.CloneIngressPktToEgress => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.CloneIngressPktToIngress => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.CopyHeader => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.Count => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.Drop => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.ExecuteMeter => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.GenerateDigest => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.ModifyField => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.ModifyFieldRngUniform => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.ModifyFieldWithHashBasedOffset => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.NoOp => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.Pop => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.Push => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.Recirculate => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.RegisterRead => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.RegisterWrite => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.RemoveHeader => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.Resubmit => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.ShiftLeft => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.ShiftRight => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.Subtract => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.SubtractFromField => apply(ax)
    case ax : org.change.v2.p4.model.actions.primitives.Truncate => apply(ax)
    case ax : org.change.v2.p4.model.actions.P4ComplexAction => apply(ax)
  }
}
