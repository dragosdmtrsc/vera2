...
trait ASTVisitor {
  ...
  def preorder(actCall: org.change.p4.model.actions.P4ActionCall): Boolean =
    true
  ...
  def postorder(actCall: org.change.p4.model.actions.P4ActionCall): Unit = {}
  def postorder(paramExpression: ParamExpression): Unit = {}

  def preorder(action: org.change.p4.model.actions.primitives.Add): Boolean =
    true
  def preorder(
    action: org.change.p4.model.actions.primitives.AddHeader
  ): Boolean = true
  def preorder(
    action: org.change.p4.model.actions.primitives.AddToField
  ): Boolean = true
  def preorder(action: org.change.p4.model.actions.primitives.BitAnd): Boolean =
    true
  def preorder(action: org.change.p4.model.actions.primitives.BitOr): Boolean =
    true
  def preorder(action: org.change.p4.model.actions.primitives.BitXor): Boolean =
    true
  def preorder(
  ...
  def preorder(
    action: org.change.p4.model.actions.primitives.CopyHeader
  ): Boolean = true
  def preorder(action: org.change.p4.model.actions.primitives.Count): Boolean =
    true
  def preorder(action: org.change.p4.model.actions.primitives.Drop): Boolean =
    true
  def preorder(
  ...
  def preorder(action: org.change.p4.model.actions.primitives.NoOp): Boolean =
    true
  def preorder(action: org.change.p4.model.actions.primitives.Pop): Boolean =
    true
  def preorder(action: org.change.p4.model.actions.primitives.Push): Boolean =
    true
  def preorder(
  ...
  def preorder(
    action: org.change.p4.model.actions.primitives.Resubmit
  ): Boolean = true
  def preorder(
    action: org.change.p4.model.actions.primitives.ShiftLeft
  ): Boolean = true
  def preorder(
    action: org.change.p4.model.actions.primitives.ShiftRight
  ): Boolean = true
  def preorder(
    action: org.change.p4.model.actions.primitives.Subtract
  ): Boolean = true
  def preorder(
    action: org.change.p4.model.actions.primitives.SubtractFromField
  ): Boolean = true
  def preorder(
    action: org.change.p4.model.actions.primitives.Truncate
  ): Boolean = true
  def preorder(action: org.change.p4.model.actions.P4ComplexAction): Boolean =
    true
  def postorder(action: org.change.p4.model.actions.primitives.Add): Unit = {}
  def postorder(
    action: org.change.p4.model.actions.primitives.AddHeader
  ): Unit = {}
  def postorder(
  ...
  def postorder(action: org.change.p4.model.actions.primitives.BitAnd): Unit = {}
  def postorder(action: org.change.p4.model.actions.primitives.BitOr): Unit = {}
  def postorder(action: org.change.p4.model.actions.primitives.BitXor): Unit = {}
  def postorder(
    action: org.change.p4.model.actions.primitives.CloneEgressPktToEgress
  ): Unit = {}
  def postorder(
  ...
  def postorder(action: org.change.p4.model.actions.primitives.Count): Unit = {}
  def postorder(action: org.change.p4.model.actions.primitives.Drop): Unit = {}
  def postorder(
    action: org.change.p4.model.actions.primitives.ExecuteMeter
  ): Unit = {}
  def postorder(
  ...
  def postorder(action: org.change.p4.model.actions.primitives.NoOp): Unit = {}
  def postorder(action: org.change.p4.model.actions.primitives.Pop): Unit = {}
  def postorder(action: org.change.p4.model.actions.primitives.Push): Unit = {}
  def postorder(
    action: org.change.p4.model.actions.primitives.Recirculate
  ): Unit = {}
  def postorder(
  ...
  def postorder(action: org.change.p4.model.actions.P4ComplexAction): Unit = {}
