...
public class ClickParser extends Parser {
    ...
    public static class LineContext extends ParserRuleContext {
        public TerminalNode NEWLINE() {
            return getToken(ClickParser.NEWLINE, 0);
        }
    ...
    public static class NewElementContext extends ParserRuleContext {
        ...
        public TerminalNode DEFINE_SYMBOL() {
            return getToken(ClickParser.DEFINE_SYMBOL, 0);
        }
    ...
    public static class ConfigParameterContext extends ParserRuleContext {
        ...
        public List<TerminalNode> NUMERIC_CONF_PARAM() {
            return getTokens(ClickParser.NUMERIC_CONF_PARAM);
        }
        ...
        public List<TerminalNode> DASH() {
            return getTokens(ClickParser.DASH);
        }

        public List<TerminalNode> CONJUNCTION() {
            return getTokens(ClickParser.CONJUNCTION);
        }
        ...
        public List<TerminalNode> NUMBER() {
            return getTokens(ClickParser.NUMBER);
        }

        public List<TerminalNode> CAPITALIZED_STRING() {
            return getTokens(ClickParser.CAPITALIZED_STRING);
        }

        public List<TerminalNode> NON_CAPITALIZED_STRING() {
            return getTokens(ClickParser.NON_CAPITALIZED_STRING);
        }
    ...
    public static class ClassNameContext extends ParserRuleContext {
        public TerminalNode CAPITALIZED_STRING() {
            return getToken(ClickParser.CAPITALIZED_STRING, 0);
        }
    ...
    public static class ElementNameContext extends ParserRuleContext {
        public TerminalNode NON_CAPITALIZED_STRING() {
            return getToken(ClickParser.NON_CAPITALIZED_STRING, 0);
        }
    ...
    public static class InTheMiddleContext extends ParserRuleContext {
        ...
        public TerminalNode ARROW() {
            return getToken(ClickParser.ARROW, 0);
        }
    ...
    public static class PortIdContext extends ParserRuleContext {
        public TerminalNode NUMBER() {
            return getToken(ClickParser.NUMBER, 0);
        }
