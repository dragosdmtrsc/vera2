...
public class ReachLangParser extends Parser {
    ...
    public static class RequirementsContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitRequirements(this);
    ...
    public static class TestContext extends ParserRuleContext {
        ...
        public List<TerminalNode> ARROW() {
            return getTokens(ReachLangParser.ARROW);
        }
    ...
    public static class EntranceContext extends ParserRuleContext {
        ...
        public TerminalNode INTERNET() {
            return getToken(ReachLangParser.INTERNET, 0);
        }

        public TerminalNode CLIENT() {
            return getToken(ReachLangParser.CLIENT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitEntrance(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ConditionContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitCondition(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TrafficdescContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_trafficdesc;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitTrafficdesc(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class InvariantContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitInvariant(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ConstraintContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitConstraint(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IpfieldContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitIpfield(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IpconstraintContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_ipconstraint;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitIpconstraint(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class L4fieldContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitL4field(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class L4constraintContext extends ParserRuleContext {
        ...
        public TerminalNode NUMBER() {
            return getToken(ReachLangParser.NUMBER, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_l4constraint;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitL4constraint(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ProtoconstraintContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_protoconstraint;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof ReachLangVisitor)
                return ((ReachLangVisitor<? extends T>) visitor).visitProtoconstraint(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NportContext extends ParserRuleContext {
        public List<TerminalNode> ID() {
            return getTokens(ReachLangParser.ID);
        }
    ...
    public static class Ipv4Context extends ParserRuleContext {
        ...
        public List<TerminalNode> NUMBER() {
            return getTokens(ReachLangParser.NUMBER);
        }
