...
public class IptablesParser extends Parser {
	...
	public final RleContext rle() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(159); match(T__56);
			setState(160); chainname();
			setState(164);
			_errHandler.sync(this);
			_la = _input.LA(1);
	...
	public final ChainContext chain() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(170); match(T__96);
			setState(171); chainname();
	...
	public final TargetNameContext targetName() throws RecognitionException {
		...
		try {
			...
			case T__99:
				{
				setState(182); acceptTarget();
				}
				break;
			case T__16:
				{
				setState(183); dropTarget();
				}
				break;
			case T__40:
				{
				setState(184); returnTarget();
				}
				break;
			case T__91:
				{
				setState(185); checksumTarget();
				}
				break;
			case T__24:
				{
				setState(186); connmarkTarget();
				}
				break;
			case T__38:
				{
				setState(187); ctTarget();
				}
				break;
			case T__72:
				{
				setState(188); dnatTarget();
				}
				break;
			case T__88:
				{
				setState(189); markTarget();
				}
				break;
			case T__61:
				{
				setState(190); notrackTarget();
				}
				break;
			case T__74:
				{
				setState(191); redirectTarget();
				}
				break;
			case T__69:
				{
				setState(192); rejectTarget();
				}
				break;
			case T__57:
				{
				setState(193); setTarget();
				}
				break;
			case T__9:
				{
				setState(194); snatTarget();
				}
				break;
			case T__21:
				{
				setState(195); masqueradeTarget();
				}
				break;
			case NAME:
				{
	...
	public static class MasqueradeTargetContext extends ParserRuleContext {
		public TerminalNode RANGE() { return getToken(IptablesParser.RANGE, 0); }
		...
		@Override public int getRuleIndex() { return RULE_masqueradeTarget; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public final ChecksumTargetContext checksumTarget() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(212); match(T__91);
			setState(213); checksumTargetOpts();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ConnmarkTargetContext connmarkTarget() throws RecognitionException {
		...
		try {
			...
			while (_la==T__73 || _la==T__11) {
				{
				{
				setState(219); connmarkTargetOpts();
				}
				}
				setState(224);
				_errHandler.sync(this);
	...
	public final MaskingOptionContext maskingOption() throws RecognitionException {
		...
		try {
			...
			case T__93:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(241); match(T__93);
				setState(242); nfCtMask();
				}
				break;
			case T__101:
	...
	public final CtTargetContext ctTarget() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(249); match(T__38);
			setState(250); ctTargetOpts();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CtZoneContext ctZone() throws RecognitionException {
		...
		try {
			...
			setState(260); ((CtZoneContext)_localctx).id = match(INT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DnatTargetContext dnatTarget() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(266); match(T__72);
			setState(267); match(T__39);
			setState(268); match(IP);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DnatTargetOptsContext dnatTargetOpts() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(270); match(T__39);
			setState(271); match(IP);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MarkTargetContext markTarget() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(273); match(T__88);
			setState(274); match(T__30);
			setState(275); match(INT);
			setState(278);
			_la = _input.LA(1);
			if (_la==T__28) {
				{
				setState(276); match(T__28);
	...
	public final RedirectTargetContext redirectTarget() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(288); match(T__74);
			setState(289); match(T__52);
	...
	public final RejectTargetContext rejectTarget() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(295); match(T__69);
			setState(296); rejectTargetOpts();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SetTargetContext setTarget() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(301); match(T__57);
			setState(302); setTargetOpts();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SetTargetOptsContext setTargetOpts() throws RecognitionException {
		...
		try {
			...
			while (_la==T__92) {
				...
				setState(315); ((SetTargetOptsContext)_localctx).setname = match(NAME);
				setState(316); flag();
				setState(321);
				_errHandler.sync(this);
				_la = _input.LA(1);
				...
				setState(324); match(T__94);
				setState(325); ((SetTargetOptsContext)_localctx).value = match(INT);
				setState(326); match(T__51);
				}
				}
				setState(332);
				_errHandler.sync(this);
	...
	public final SnatTargetContext snatTarget() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(333); match(T__9);
			setState(334); match(T__7);
			setState(335); match(IP);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MatchContext match() throws RecognitionException {
		...
		try {
			...
			case 2:
				{
				setState(342); protocol();
				}
				break;

			case 3:
				{
				setState(343); sourceaddr();
				}
				break;

			case 4:
				{
				setState(344); dstaddr();
				}
				break;
			...
			case 7:
				{
				setState(347); iniface();
				}
				break;

			case 8:
				{
				setState(348); outiface();
				}
				break;
	...
	public final CtrsContext ctrs() throws RecognitionException {
		...
		try {
			...
			consume();
			setState(366); ((CtrsContext)_localctx).packets = match(INT);
			setState(367); ((CtrsContext)_localctx).bytes = match(INT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final InifaceContext iniface() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(369); ((InifaceContext)_localctx).neg = match(T__62);
				}
			}
			...
			consume();
			setState(373); ((InifaceContext)_localctx).iface = match(NAME);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OutifaceContext outiface() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(375); ((OutifaceContext)_localctx).neg = match(T__62);
				}
			}
			...
			consume();
			setState(379); ((OutifaceContext)_localctx).iface = match(NAME);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ModuleContext module() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(381); match(MATCH);
			setState(394);
			switch (_input.LA(1)) {
			case T__37:
				{
				setState(382); tcpopts();
				}
				break;
			case T__46:
				{
				setState(383); udpopts();
				}
				break;
			case T__29:
				{
				setState(384); icmpopts();
				}
				break;
			case T__15:
				{
				setState(385); connmarkopts();
				}
				break;
			case T__60:
				{
				setState(386); markopts();
				}
				break;
			case T__23:
				{
				setState(387); conntrackopts();
				}
				break;
			case T__31:
				{
				setState(388); commentopts();
				}
				break;
			case T__47:
			case NAME:
				{
				setState(389); icmp6opts();
				}
				break;
			case T__6:
				{
				setState(390); macopts();
				}
				break;
			case T__68:
				{
				setState(391); physdevopts();
				}
				break;
			case T__103:
				{
				setState(392); setopts();
				}
				break;
			case T__55:
				{
				setState(393); stateopts();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ConnmarkoptsContext connmarkopts() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(396); match(T__15);
			setState(398);
			_la = _input.LA(1);
			if (_la==T__62) {
				{
				setState(397); ((ConnmarkoptsContext)_localctx).neg = match(T__62);
				}
			}

			setState(400); match(T__97);
			setState(401); match(INT);
			setState(404);
			_la = _input.LA(1);
			if (_la==T__28) {
				{
				setState(402); match(T__28);
				setState(403); match(INT);
				}
			}
	...
	public final ConntrackvarsContext conntrackvars() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(412); ((ConntrackvarsContext)_localctx).neg = match(T__62);
				}
			}

			setState(415); match(T__63);
			setState(416); statelist();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MarkoptsContext markopts() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(438); match(T__60);
			setState(440);
			_la = _input.LA(1);
			if (_la==T__62) {
				{
				setState(439); ((MarkoptsContext)_localctx).neg = match(T__62);
				}
			}

			setState(442); match(T__97);
			setState(443); match(INT);
			setState(446);
			_la = _input.LA(1);
			if (_la==T__28) {
				{
				setState(444); match(T__28);
	...
	public final CommentoptsContext commentopts() throws RecognitionException {
		...
		try {
			...
			setState(449); match(T__44);
			setState(450); match(STRING);
	...
	public final Icmp6optsContext icmp6opts() throws RecognitionException {
		...
		try {
			...
			case T__47:
				enterOuterAlt(_localctx, 1);
				{
				setState(453); match(T__47);
				setState(455);
				_la = _input.LA(1);
				if (_la==T__62) {
					{
					setState(454); match(T__62);
					}
				}

				setState(457); match(T__83);
				setState(458); ((Icmp6optsContext)_localctx).type = match(INT);
				setState(461);
				_la = _input.LA(1);
				if (_la==T__28) {
					{
					setState(459); match(T__28);
					setState(460); ((Icmp6optsContext)_localctx).code = match(INT);
					}
				}
			...
			case NAME:
				enterOuterAlt(_localctx, 2);
				{
				setState(463); ((Icmp6optsContext)_localctx).typename = match(NAME);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final MacoptsContext macopts() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(467); ((MacoptsContext)_localctx).neg = match(T__62);
				}
			}

			setState(470); match(T__32);
			setState(471); macaddress();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MacaddressContext macaddress() throws RecognitionException {
		...
		try {
			...
			setState(475); match(T__64);
			setState(476); match(HEX_DIGIT);
			setState(477); match(HEX_DIGIT);
			setState(478); match(T__64);
			setState(479); match(HEX_DIGIT);
			setState(480); match(HEX_DIGIT);
			setState(481); match(T__64);
			setState(482); match(HEX_DIGIT);
			setState(483); match(HEX_DIGIT);
			setState(484); match(T__64);
			setState(485); match(HEX_DIGIT);
			setState(486); match(HEX_DIGIT);
			setState(487); match(T__64);
			setState(488); match(HEX_DIGIT);
			setState(489); match(HEX_DIGIT);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final PhysdevvarsContext physdevvars() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				if (_la==T__62) {
					{
					setState(497); ((PhysdevInContext)_localctx).neg = match(T__62);
					}
				}

				setState(500); match(T__54);
				setState(501); match(NAME);
				}
				break;
			...
			case 2:
				...
				if (_la==T__62) {
					{
					setState(502); ((PhysdevOutContext)_localctx).neg = match(T__62);
					}
				}

				setState(505); match(T__76);
				setState(506); match(NAME);
				}
				break;
			...
			case 3:
				...
				if (_la==T__62) {
					{
					setState(507); ((PhysdevIsBridgedContext)_localctx).neg = match(T__62);
					}
				}

				setState(510); match(T__80);
				}
				break;
			}
		}
	...
	public final SetvarsContext setvars() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(519); ((SetvarsContext)_localctx).neg = match(T__62);
				}
			}

			setState(522); match(T__67);
			setState(523); ((SetvarsContext)_localctx).setname = match(NAME);
			setState(524); flagset();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final StateoptsContext stateopts() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(543); ((StateoptsContext)_localctx).neg = match(T__62);
				}
			}

			setState(546); match(T__25);
			setState(547); state();
			}
		}
		catch (RecognitionException re) {
	...
	public final IcmpoptsContext icmpopts() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(558); ((IcmpoptsContext)_localctx).neg = match(T__62);
				}
			}

			setState(561); match(T__14);
			setState(562); icmptype();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DportContext dport() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(579); ((DportContext)_localctx).neg = match(T__62);
				}
			}

			setState(582); match(T__84);
			setState(583); portno();
			}
		}
		catch (RecognitionException re) {
	...
	public final SportContext sport() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(585); ((SportContext)_localctx).neg = match(T__62);
				}
			}

			setState(588); match(T__98);
			setState(589); portno();
			}
		}
		catch (RecognitionException re) {
	...
	public final ProtocolContext protocol() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(593); ((ProtocolContext)_localctx).neg = match(T__62);
				}
			}
	...
	public final SourceaddrContext sourceaddr() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(599); ((SourceaddrContext)_localctx).neg = match(T__62);
				}
			}
			...
			consume();
			setState(603); addressExpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final DstaddrContext dstaddr() throws RecognitionException {
		...
		try {
			...
			if (_la==T__62) {
				{
				setState(610); ((DstaddrContext)_localctx).neg = match(T__62);
				}
			}
			...
			consume();
			setState(614); addressExpression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
